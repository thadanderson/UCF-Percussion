...
export const PERCUSSION_DATA: LevelMap = {
  ...
  "Drum Set Deficient": {
    "Rock/Funk Controls": [
      ...
      "Control 6",
      "Control 11",
      "Control 11 (alternating)",
      "Control 18",
      "Control 23",
      "Control 25",
      "Control 26",
    ].map((label) => createItem(label, "Rock/Funk Controls")),
    "Rock/Funk Variables": [
      "Variables 1-14",
      "Variables 15-28",
      "Variables 29-42",
    ].map((label) => createItem(label, "Rock/Funk Variables")),
    "Swing Variables": [
      "Variables 1-10",
      "Variables 11-20",
      "Variables 21-30",
      ...
      "Variables 81-90",
      "Variables 91-100",
    ].map((label) => createItem(label, "Swing Variables")),
    "Groove Essentials": [
      "Groove 1, Slow",
      "Groove 1, Fast",
      "Groove 2, Slow",
      ...
      "Groove 10, Slow",
      "Groove 27, Disco",
      "Groove 28, Classic 2-beat, Fast",
    ].map((label) => createItem(label, "Groove Essentials")),
  },
  ...
  "Drum Set 1": {
    ...
    "The Jazz Drummer's Reading Workbook": [
      ...
      "Nathan's Number",
      "Beast's Debacle",
    ].map((label) => createItem(label, "The Jazz Drummer's Reading Workbook")),
  },
  ...
  "Drum Set 2": {
    "Drum Set Control": [
      ...
      "Exercises 72-77",
      "Exercises 78-83",
    ].map((label) => createItem(label, "Drum Set Control")),
    "The New Breed (Systems)": [
      "System 3","System 5","System 7","System 9","System 11","System 13",
      "System 14","System 16","System 23","System 24","System 27","System 29",
    ].map((label) => createItem(label, "The New Breed (Systems)")),
    "The New Breed (Melodies)": [
      "Melody IB","Melody IIB","Melody IIIB","Melody VB",
    ].map((label) => createItem(label, "The New Breed (Melodies)")),
    "Drummer's Collective Afro-Caribbean": [
      "Bolero","Cha-cha-cha","Mambo","Son",
      "Guaguanco","Mozambique","Conga de Comparsa","Songo",
    ].map((label) => createItem(label, "Drummer's Collective Afro-Caribbean")),
  },
  ...
  "Drum Set 3": {
    ...
    ].map((label) => createItem(label, "Time Functioning Patterns")),
    "Masters of Time": [
      "Foster: Song for My Father",
      "Riley: Yardbird Suite",
      "Nussbaum: Like Sonny",
      "Goodwin: September Song",
      "Foster: Strollin'",
      "Smith: Robbins' Nest",
      "Hart: Toys",
      "Foster: Summer in Central Park",
      "Nussbaum: A Love Supreme",
      "Hayes: Scotch and Soda",
    ].map((label) => createItem(label, "Masters of Time")),
  },
  ...
  "Drum Set 4": {
    "Style Studies": [
      ...
      "Medium Salsa",
      "Merengue",
      "New Orleans 2nd Line SLOW",
      "New Orleans 2nd Line FAST",
      "Reggae SLOW",
      "Reggae FAST",
      "Salsa",
      "Samba Partido Alto",
      "Soca",
      "Tango",
    ].map((label) => createItem(label, "Style Studies")),
    "Standard Time": [
      "Blue Fish Road",
      "Soul Buddies",
      "Woman In Rio",
      ...
      "Where Is She",
      "Blind by Day",
    ].map((label) => createItem(label, "Standard Time")),
  },
};
