    ...
    <div className="max-w-3xl">
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <div className="flex gap-2 shrink-0">
          <Link
            href={`/admin/assessments/rubric/${id}/score`}
      ...
      <div className="bg-gray-50 border border-gray-200 rounded p-4">
        ...
        <div className="flex flex-wrap gap-2">
          {FACULTY.map((f) => (
            <a
              key={f}
              href={`/admin/assessments/rubric/export?faculty=${f}&semester=${encodeURIComponent(assessment.semester)}`}
          ...
          <a
            href={`/admin/assessments/rubric/export?faculty=average&semester=${encodeURIComponent(assessment.semester)}`}
